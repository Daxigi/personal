...
return new class extends Migration
{
    ...
    {
        Schema::create('as_tardanzas_tj', function (Blueprint $table) {
            ...
            $table->index(['fecha', 'legajo'], 'as_tardanzas_tj_i1');
            $table->index(['legajo', 'fecha'], 'as_tardanzas_tj_i2');
        });
    }
    ...
    {
        Schema::dropIfExists('as_tardanzas_tj');
    }
};
