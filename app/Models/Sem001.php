 ...
 * @property Carbon|null $e01fecha_oficio
 ...
 * @property string|null $gedo
 * 
 * @property Per001 $per001
 *
 * @package App\Models
 */
class Sem001 extends Model
{
	protected $table = 'sem001';
	...
	{
		return $this->belongsTo(Per001::class, 'e01legajo');
	}
}
